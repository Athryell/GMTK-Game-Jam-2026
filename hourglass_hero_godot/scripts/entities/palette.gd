...
## Danger still reads the same way when charged: the ramp runs from the blue
## instead of from the gold, and ends on the same red.
...
## screen edge and on the gauge, not in the hand you are looking at.
